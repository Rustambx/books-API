            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group required row">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('name', old('name') ?: $vocabulary->name, [
                    ...
                    <div class="form-group required row">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('slug', old('slug') ?: $vocabulary->slug, [
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {!! Form::textarea('description', old('description') ?: $vocabulary->description, [
