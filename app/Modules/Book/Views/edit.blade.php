            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <img src="{{ $book->resized_image }}" alt="">
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                            <select name="authors[]" id="authors" class="form-control" multiple>
                                ...
                                @foreach($authors as $author)
                                    <option value="{{ $author->id }}" @if($author->option == true) selected @endif>
                                        {{ $author->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div>
                                ...
                                <label for="chapters_file">Несколько глав и аудио файлы</label>
                            </div>
                            ...
                            <select name="parent_id" id="parent_id" class="form-control">
                                ...
                                @if ($genres->isNotEmpty())
                                    @foreach ($genres as $item)
                                        <option value="{{ $item->id }}" @if($book->vocabulary_id == $item->id) selected @endif>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                @endif
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="term_id" id="term_id" class="form-control" multiple>
